...
const CustomerClassPage = () => {
	...
	const handleSaveButtonClick = async () => {
		try {
			...
			await saveInFirestore(finalValues, 'customerClass');
		} catch (error) {
	...
	useEffect(() => {
		getSettingFromFirestore('customerClass');
	}, []);
		...
		<PageWrapper name='Master Settings'>
			...
			<Container>
				<Card className='h-full'>
					<CardHeader>
						<CardHeaderChild>
							<CardTitle>Customer Class</CardTitle>
						</CardHeaderChild>
						<CardHeaderChild>
							<Button
								type='button'
...
export default CustomerClassPage;
