...
const SalesmanMaintenancePage = () => {
	...
	const handleSaveButtonClick = async () => {
		try {
			...
			await saveInFirestore(finalValues, 'salesmanMaintenance');
		} catch (error) {
	...
	useEffect(() => {
		getSettingFromFirestore('salesmanMaintenance');
	}, []);
		...
		<PageWrapper name='Master Settings'>
			...
			<Container>
				<Card className='h-full'>
					<CardHeader>
						<CardHeaderChild>
							<CardTitle>Salesman Maintenance</CardTitle>
						</CardHeaderChild>
						<CardHeaderChild>
							<Button
								type='button'
...
export default SalesmanMaintenancePage;
