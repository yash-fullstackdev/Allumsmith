...
const SearchPartial = () => {
	...
	// const list = [
	// 	...Object.values(componentsPages.uiPages.subPages).map((i: any) => ({
	// 		...i as any,
	// 		category: 'Component',
	// 	})),
	// 	...Object.values(componentsPages.formPages.subPages).map((i: any) => ({
	// 		...i as any,
	// 		category: 'Form',
	// 	})),
	// 	...Object.values(componentsPages.integratedPages.subPages).map((i: any) => ({
	// 		...i as any,
	// 		category: 'Other',
	// 	})),
	// ];
