...
type TReactSelect = Partial<
  CreatableProps<TSelectOption, boolean, GroupBase<TSelectOption>>
>;
...
const CreateSelectReact: FC<ISelectReactProps> = (props) => {
  const {
    borderWidth,
    className,
    color,
  ...
  return (
    <CreatableSelect
      ...
      classNames={{
        ...
        dropdownIndicator: () => classNames('text-black/50', 'dark:text-white/50'),
        multiValue: (state) =>
          classNames(
            `bg-${color as TColors}-${colorIntensity as TColorIntensity}`,
            'm-0.5',
...
CreateSelectReact.defaultProps = {
...
CreateSelectReact.displayName = 'Select';

export default CreateSelectReact;
