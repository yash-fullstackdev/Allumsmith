...
const Input = forwardRef<HTMLInputElement, IInputProps>((props, ref) => {
	...
	const classes = classNames(
		...
		className,
		isCapitalized && 'uppercase',  // Apply text-uppercase class if isCapitalized is true
	);

	const uppercaseValue = isCapitalized ? (value as string).toUpperCase() : value;


	return (
		<input ref={ref} data-component-name='Input' className={classes} value={uppercaseValue} name={name} {...rest} />
	);
});
Input.defaultProps = {
	...
	value: '',
	variant: 'solid',
	isCapitalized: false,  // Set default value for isCapitalized
};
